...
if (
  ...
  console.error("\x1b[1;31mUsage: lcm <integer> <integer>\x1b[0m");
  process.exit(1);
}
  ...
  spinnerInterval = setInterval(() => {
    ...
    if (currentState === "PENDING") {
      ...
      process.stdout.write(
        `\r\x1b[1;36m[ ${char} ] CALCULATING LCM(${formattedTargetA}, ${formattedTargetB})${dots} \x1b[0m`,
      );
    }
    idx++;
  }, 100);
...
const execute = async () => {
  ...
  try {
    ...
    const res = await fetch(`${API_BASE}/api/tasks/lcm`, {
      method: method,
