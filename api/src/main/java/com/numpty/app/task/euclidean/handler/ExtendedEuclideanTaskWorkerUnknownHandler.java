...
public class ExtendedEuclideanTaskWorkerUnknownHandler implements ListenerHandler {

    private final ExtendedEuclideanTaskService taskService;
    private final ExtendedEuclideanTaskMapper taskMapper;

    public ExtendedEuclideanTaskWorkerUnknownHandler(ExtendedEuclideanTaskService taskService, ExtendedEuclideanTaskMapper taskMapper) {
