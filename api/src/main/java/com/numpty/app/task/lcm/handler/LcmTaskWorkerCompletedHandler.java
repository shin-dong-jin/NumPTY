...
public class LcmTaskWorkerCompletedHandler implements ListenerHandler {

    private final LcmTaskService taskService;
    private final LcmTaskMapper taskMapper;

    public LcmTaskWorkerCompletedHandler(LcmTaskService taskService, LcmTaskMapper taskMapper) {
