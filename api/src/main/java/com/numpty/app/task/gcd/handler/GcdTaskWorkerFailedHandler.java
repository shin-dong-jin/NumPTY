...
public class GcdTaskWorkerFailedHandler implements ListenerHandler {

    private final GcdTaskService taskService;
    private final GcdTaskMapper taskMapper;


    public GcdTaskWorkerFailedHandler(GcdTaskService taskService, GcdTaskMapper taskMapper) {
