...
public class PrimalityTestTaskJedisRepository {
    ...
    public PrimalityTestTaskJedisRepository(JedisPoolProvider poolProvider,
        PrimalityTestTaskMapper taskMapper) {
        this.poolProvider = poolProvider;
        this.taskMapper = taskMapper;
    }

    public void xAddStream(Task<PrimalityTestTaskPayload> task) {
