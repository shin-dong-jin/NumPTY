...
public class LcmTaskJedisRepository {
    ...
    public LcmTaskJedisRepository(JedisPoolProvider poolProvider, LcmTaskMapper taskMapper) {
        this.poolProvider = poolProvider;
        this.taskMapper = taskMapper;
    }

    public void xAddStream(Task<LcmTaskPayload> task) {
