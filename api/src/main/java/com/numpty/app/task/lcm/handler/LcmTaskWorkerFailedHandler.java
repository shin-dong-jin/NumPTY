...
public class LcmTaskWorkerFailedHandler implements ListenerHandler {

    private final LcmTaskService taskService;
    private final LcmTaskMapper taskMapper;

    public LcmTaskWorkerFailedHandler(LcmTaskService taskService, LcmTaskMapper taskMapper) {
