...
public class PrimalityTestTaskWorkerWorkingHandler implements ListenerHandler {

    private final PrimalityTestTaskService taskService;
    private final PrimalityTestTaskMapper taskMapper;

    public PrimalityTestTaskWorkerWorkingHandler(PrimalityTestTaskService taskService, PrimalityTestTaskMapper taskMapper) {
