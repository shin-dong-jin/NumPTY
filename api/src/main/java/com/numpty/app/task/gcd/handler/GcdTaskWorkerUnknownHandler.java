...
public class GcdTaskWorkerUnknownHandler implements ListenerHandler {

    private final GcdTaskService taskService;
    private final GcdTaskMapper taskMapper;

    public GcdTaskWorkerUnknownHandler(GcdTaskService taskService, GcdTaskMapper taskMapper) {
