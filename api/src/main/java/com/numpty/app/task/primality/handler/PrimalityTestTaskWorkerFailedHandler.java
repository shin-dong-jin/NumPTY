...
public class PrimalityTestTaskWorkerFailedHandler implements ListenerHandler {

    private final PrimalityTestTaskService taskService;
    private final PrimalityTestTaskMapper taskMapper;

    public PrimalityTestTaskWorkerFailedHandler(PrimalityTestTaskService taskService, PrimalityTestTaskMapper taskMapper) {
