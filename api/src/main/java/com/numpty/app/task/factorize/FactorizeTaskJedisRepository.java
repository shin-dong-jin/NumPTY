...
public class FactorizeTaskJedisRepository {
    ...
    public FactorizeTaskJedisRepository(JedisPoolProvider poolProvider,
        FactorizeTaskMapper taskMapper) {
        this.poolProvider = poolProvider;
        this.taskMapper = taskMapper;
    }

    public void xAddStream(Task<FactorizeTaskPayload> task) {
