...
public class ExtendedEuclideanTaskWorkerWorkingHandler implements ListenerHandler {

    private final ExtendedEuclideanTaskService taskService;
    private final ExtendedEuclideanTaskMapper taskMapper;

    public ExtendedEuclideanTaskWorkerWorkingHandler(ExtendedEuclideanTaskService taskService, ExtendedEuclideanTaskMapper taskMapper) {
