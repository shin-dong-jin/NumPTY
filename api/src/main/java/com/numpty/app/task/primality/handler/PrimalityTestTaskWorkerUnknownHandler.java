...
public class PrimalityTestTaskWorkerUnknownHandler implements ListenerHandler {

    private final PrimalityTestTaskService taskService;
    private final PrimalityTestTaskMapper taskMapper;

    public PrimalityTestTaskWorkerUnknownHandler(PrimalityTestTaskService taskService, PrimalityTestTaskMapper taskMapper) {
