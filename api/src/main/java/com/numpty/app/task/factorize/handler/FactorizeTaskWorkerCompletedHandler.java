...
public class FactorizeTaskWorkerCompletedHandler implements ListenerHandler {

    private final FactorizeTaskService taskService;
    private final FactorizeTaskMapper taskMapper;

    public FactorizeTaskWorkerCompletedHandler(FactorizeTaskService taskService,
