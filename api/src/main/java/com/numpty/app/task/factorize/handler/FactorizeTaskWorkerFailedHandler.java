...
public class FactorizeTaskWorkerFailedHandler implements ListenerHandler {

    private final FactorizeTaskService taskService;
    private final FactorizeTaskMapper taskMapper;

    public FactorizeTaskWorkerFailedHandler(FactorizeTaskService taskService, FactorizeTaskMapper taskMapper) {
